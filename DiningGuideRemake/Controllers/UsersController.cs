...
namespace DiningGuideRemake.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(DiningGuideData context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idUser,FirstName,LastName,Email,Password,Type")] User user)
        {
            if (id != user.idUser)
            {
                return NotFound();
